...
interface CategoryConflictModalProps {
  open: boolean;
  /** Name of the category the group/event uses */
  dominantCategoryName: string;
  /** How many contributions match */
  compatibleCount: number;
  /** How many contributions conflict */
  conflictingCount: number;
  /** Option A: change the conflicting contributions' category to match the group/event */
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-surface border border-rim shadow-2xl p-5 space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-sm font-semibold text-ink">Konflikt kategórie</h2>
            <p className="mt-1 text-xs text-ink-dim leading-relaxed">
              ...
              inú kategóriu ako táto skupina/udalosť{" "}
        ...
        <div className="space-y-2">
          ...
          >
            <p className="text-sm font-semibold text-ink">
              B: Nepridať príspevky s inou kategóriou
            </p>
            <p className="mt-0.5 text-xs text-ink-dim">
              {compatibleCount > 0
