        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-rim shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-ink">
              {view === "list" ? t.components.eventPickerListTitle : t.components.eventPickerCreateTitle}
            </h2>
          </div>
          ...
          <>
            ...
            <div className="overflow-y-auto flex-1">
              {loading ? (
                ...
                <div className="py-10 text-center text-sm text-ink-subtle">{t.components.eventPickerEmpty}</div>
              ) : (
                events.map((ev) => (
                  <button
                    key={ev.id}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-ink-subtle">
                        {t.chronicler.contributionPluralCount(ev.contributionIds.length)}
            ...
            <div className="px-4 py-3 border-t border-rim shrink-0 flex flex-col gap-2">
              {onCreateAndAssign && (
                ...
                >
                  {t.components.eventPickerCreateNew}
                </button>
              )}
              <button
                onClick={onClose}
          ...
          <>
            <div className="overflow-y-auto flex-1 px-4 py-4 space-y-4">
              ...
              {categories && categories.length > 0 && (
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-ink-dim">{t.chronicler.eventGroupLabel}</label>
            ...
            <div className="px-4 py-3 border-t border-rim shrink-0 flex gap-2">
              ...
              >
                {creating ? t.components.eventPickerCreating : t.components.eventPickerCreateSubmit}
              </button>
            </div>
          </>
        )}
